...
export function App() {
  ...
  const [downloadCount, setDownloadCount] = useState(125847);
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-8">
                <div>
                  <p className="text-3xl font-bold text-white">{downloadCount.toLocaleString()}+</p>
                ...
                <div>
                  <p className="text-3xl font-bold text-white">2.5M kg</p>
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  ...
                  className="absolute -left-16 top-20 bg-white/10 backdrop-blur rounded-2xl p-4 border border-white/20"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white text-sm font-semibold">Plastic Detected</p>
                      <p className="text-green-400 text-xs">+15 Points</p>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute -right-12 bottom-32 bg-white/10 backdrop-blur rounded-2xl p-4 border border-white/20"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-purple-400 text-xs">Eco Warrior</p>
                    </div>
                  </div>
                </motion.div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Everything you need to reduce waste, earn rewards, and track your environmental impact
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className={`bg-gray-800/50 backdrop-blur border border-gray-700 rounded-2xl p-6 hover:border-green-500/50 transition-all group ${feature.onClick ? 'cursor-pointer' : ''}`}
              >
      ...
      <section id="technology" className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Powered by advanced AI, IoT sensors, and cloud infrastructure for seamless performance
            </p>
          </motion.div>
      ...
      <section id="impact" className="py-20 px-4 bg-gray-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              See how our community is making a difference in waste reduction and carbon savings
            </p>
          </motion.div>

          <div className="grid lg:grid-cols-2 gap-8">
            {/* Waste vs Recycling Chart */}
            <motion.div
      ...
      <section id="download" className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-gradient-to-br from-green-900/50 to-emerald-900/50 backdrop-blur border border-green-500/30 rounded-3xl p-8 md:p-12 text-center"
          >
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-gray-800 border border-gray-700 rounded-xl px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500"
                />
